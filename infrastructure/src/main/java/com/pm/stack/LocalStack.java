...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        CfnHealthCheck authServiceDbHealthCheck = createDbHealthCheck("AuthServiceDBHealthCheck", authServiceDb);
        CfnHealthCheck patientServiceDbHealthCheck = createDbHealthCheck("PatientServiceDBHealthCheck", patientServiceDb);
        ...
        FargateService authService = createFargateService("AuthService", "auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "Uhfc71EuRq9DamC21ehznHmCMEKpiOF2RhTlk8U13mA="));
    ...
    public static void main(String[] args) {
        ...
        new LocalStack(app, "localstack1", props);
        app.synth();
    ...
    private CfnCluster createMskCluster() {
        ...
        return CfnCluster.Builder.create(
                        this, "MskCluster")
